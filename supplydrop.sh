...
POOL="${POOL:-/opt/app/zomboid/config/storms/pz-pool.txt}"
...
ANNOUNCE_MESSAGES=(
  "A supply drop is incoming!"
  "Choppers overhead -- looks like a supply drop!"
  "Free stuff! A supply drop just landed somewhere nearby."
  "Loot's falling from the sky -- go find it!"
)
