#!/usr/bin/env bash
# Biohazard Surge — Treat your wounds fast or bleed out.
#
#   ./event-biohazard.sh
...
EVENT_HOURS=24
EVENT_END_TIME=""
EVENT_BLURB="<RGB:0.2,1,0.6>Some fallout drifted over to the Crater of Trade.<LINE><RGB:1,0.4,0.4>Hunger and thirst drain rapidly, and injuries hit harder.<LINE><RGB:0.4,1,0.4>Medical loot spawns everywhere, and First Aid / Doctor skills gain 4x XP. Keep your bandages clean!"
